    ...
    def create_slider(self):
        ...
        if self.hitobject.extras:
            ...
            if len(slider_data) > 1:
                ...
                # Erstelle die Kurve
                curve_data = bpy.data.curves.new(name=f"{self.global_index:03d}_slider_{self.hitobject.time}_curve", type='CURVE')
                ...
                slider = bpy.data.objects.new(f"{self.global_index:03d}_slider_{self.hitobject.time}", curve_data)
